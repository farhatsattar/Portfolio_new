...
const roles = ["Full Stack Developer", "Frontend Developer", "Backend Developer" , "AI Engineer"]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Hi, I'm <span className="text-primary">Farhat Sattar</span>
            </h1>
            ...
            <div className="flex gap-4">
              ...
              <Link href="https://drive.google.com/file/d/1Bm3MRllgnDOMyqXhGAg-VmjeHe2tmiyJ/view?usp=sharing" target="_blank">
